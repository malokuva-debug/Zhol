          ...
          {rooms.map((room) => (
            ...
            >
              ...
              <div className="text-xs text-white/50">
                {room.rules.gameMode === "zhol" && `Out at ${room.rules.eliminationScore} pts`}
                {room.rules.gameMode === "pishpirik" && "Ends when 52 cards used"}
                {room.rules.gameMode === "cicmic" && "Classic rules — no points"}
              </div>

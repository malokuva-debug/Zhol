...
export default function HandFan({
  ...
  return (
    <div className="relative w-full">
      ...
      {/* 🖐️ BACK LAYER: Pushed down further to bottom-[-250px] */}
      <div className="absolute bottom-[-250px] left-1/2 -translate-x-[45%] z-[1] pointer-events-none drop-shadow-md w-36 h-auto">
      ...
      {/* ✋ FRONT LAYER: Pushed down further to bottom-[-250px] */}
      <div className="absolute bottom-[-250px] left-1/2 -translate-x-[45%] z-[250] pointer-events-none drop-shadow-xl w-36 h-auto">
        <svg viewBox="220 900 200 550" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <g id="Thumb">

...
export default function HandFan({
  ...
  return (
    <div className="relative w-full">
      ...
      {/* 🖐️ BACK LAYER: Changed from -z-10 to z-[1] so it doesn't hide behind the table! Pushed down to -200px */}
      <div className="absolute bottom-[-200px] left-1/2 -translate-x-[45%] z-[1] pointer-events-none drop-shadow-md w-56 h-auto">
          ...
          return (
            <Reorder.Item
              ...
              style={{
                ...
                // CARDS BUMPED TO START AT 10: Ensures they always sit over the back layer (which is z-[1])
      ...
      {/* ✋ FRONT LAYER: Pushed down to -200px to match perfectly with the back layer */}
      <div className="absolute bottom-[-200px] left-1/2 -translate-x-[45%] z-[250] pointer-events-none drop-shadow-xl w-56 h-auto">
        <svg viewBox="220 900 200 550" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <g id="Thumb">
